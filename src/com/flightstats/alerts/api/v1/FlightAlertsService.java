...
public interface FlightAlertsService {
     ...
     * @param events
     * @param desc
     * @return returns com.flightstats.alerts.api.v1.ResponseFlight
    ...
    ResponseFlight byDepartingFlight(
    ...
    ResponseFlight byArrivingFlight(
            @WebParam(name = "appId", targetNamespace = "")
                    String appId,
            @WebParam(name = "appKey", targetNamespace = "")
                    String appKey,
     ...
     * @param events
     * @param desc
     * @return returns com.flightstats.alerts.api.v1.ResponseRoute
     * @throws APIException_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    ResponseRoute byRouteDeparture(
            @WebParam(name = "appId", targetNamespace = "")
                    String appId,
            @WebParam(name = "appKey", targetNamespace = "")
                    String appKey,
     ...
     * @param appKey
     * @param ruleId
     * @return returns com.flightstats.alerts.api.v1.ResponseRuleById
     * @throws APIException_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
